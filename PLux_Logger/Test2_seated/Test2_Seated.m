...
%  54':31", 54':24"= 3271 − 3189 = 7 seconds +10 second of movement


startIndex = 1000 * 7 + 1 + 10*1000;
...
t2 = dataArray(1:1900, 1); 

 Fs=100;


scg_x=dataArray(1:1900, 3 ); 
scg_y=dataArray(1:1900, 4); 
scg_z=dataArray(1:1900, 2); 
...
scg_x=dataArray(1:1900, 4); 
scg_y=dataArray(1:1900, 3); 
scg_z=dataArray(1:1900, 2); 
